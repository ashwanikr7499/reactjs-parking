...
export class QueryVehicleTypes extends Component {
  ...
  async componentDidMount() {
    //called after all components are rendered and is available
  ...
  render() {
    ...
    return (
      <div class="container">
        <SplitterLayout percentage="true" secondaryMinSize="90">
          
          {/* 1 */}

          <ButtonGroup vertical className="mt-5">
            <Button variant="info" size="lg" onClick={this.onClickButton0}>
              All VEHICLES
            </Button>
