...
export class VehicleSpace extends Component {
         ...
         onClickButton2e = async () => {
           this.setState({ typeofveh:2,allOrEmpty: 1 });
         ...
         onClickButton3e = async () => {
           this.setState({ typeofveh:3,allOrEmpty: 1 });
           const url3e = "http://localhost:8080/slots/3/empty";
           const response3e = await fetch(url3e);
           const data3e = await response3e.json();
           this.setState({ vehs3e: data3e });
         };
                     ...
                     >
                       ...
                       <tbody>
                         {vehs3e.map((veh3e) => (
                           <tr key={veh3e.slotNo}>
                             <td>{veh3e.slotNo}</td>
                             <td>{veh3e.vehicleNo}</td>
                             <td>{veh3e.slotType}</td>
                             <td>{veh3e.isEmpty}</td>
                           </tr>
                         ))}
                       </tbody>
